...
vulnerability_models = {'py': pipeline('text-classification', model='python_balanced_model_model_9'), 'java': pipeline('text-classification', model='java_model_5')}
...
def predict_vulnerability():
    ...
    for language in data:
        for func_name, code in entry.items():
            ...
            func_predictions[func_name] = vulnerability_models[language](code)[0]
